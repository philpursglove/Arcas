    ...
    <>
      ...
      <div className="group flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-secondary transition-colors">
        ...
        <div className="flex-1 min-w-0">
          ...
          {song.info && (
            <p className="text-xs text-muted-foreground font-mono">{song.info}</p>
          )}
        </div>
        {song.tape && (
          <Pill>tape</Pill>
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <div className="text-center">
              <p className="font-display font-bold text-3xl text-foreground">{setlist.sets.set.length}</p>
                ...
                {set.song.map((song, songIdx) => {
                  ...
                  return (
                    <TrackRow
                      ...
                      song={song}
                      encoreName={set.name}
                      isFirstEncore={setIdx > 0 && songIdx === 0}
                    />
                  );
                })}
              </div>
